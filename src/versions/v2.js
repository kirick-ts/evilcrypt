 ...
 * @param {Buffer} payload The payload to derive the message key from.
 * @param {Buffer} key_right The right 32 bytes of the key.
 * @returns {Promise<Buffer>} The message key.
 */
